...
import 'package:support/common/widgets/animated_rotation_widget.dart';
import 'package:support/common/widgets/custom_password.dart';
import 'package:support/consts.dart';
import 'package:support/desktop/pages/connection_page.dart';
  ...
  Future<Widget> buildHelpCards() async {
    if (updateUrl.isNotEmpty && !isCardClosed) {
      return buildInstallCard(
        ...
        final Uri url = Uri.parse('https://support.com/download');
        await launchUrl(url);
      }, closeButton: true);
    }
    ...
    if (Platform.isWindows) {
      ...
      if (bind.isSelinuxEnforcing()) {
        ...
        if (bind.mainGetLocalOption(key: keyShowSelinuxHelpTip) != 'N') {
          LinuxCards.add(buildInstallCard(
            ...
            help: 'Help',
            link: 'https://support.com/docs/en/client/linux/#permissions-issue',
            closeButton: true,
      ...
      if (bind.mainCurrentIsWayland()) {
        LinuxCards.add(buildInstallCard(
            ...
            marginTop: LinuxCards.isEmpty ? 20.0 : 5.0,
            help: 'Help',
            link: 'https://support.com/docs/en/client/linux/#x11-required'));
      } else if (bind.mainIsLoginWayland()) {
        LinuxCards.add(buildInstallCard("Warning",
            "Login screen using Wayland is not supported", "", () async {},
            marginTop: LinuxCards.isEmpty ? 20.0 : 5.0,
            help: 'Help',
            link: 'https://support.com/docs/en/client/linux/#login-screen'));
      }
