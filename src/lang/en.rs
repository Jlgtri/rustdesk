...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Поддержка network..."),
        ...
        ("install_tip", "Due to UAC, Поддержка can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Поддержка to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Поддержка \"Accessibility\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Поддержка to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Поддержка Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Поддержка application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Поддержка \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Поддержка \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Поддержка."),
        ...
        ("verify_rustdesk_password_tip", "Verify Поддержка password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Поддержка and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Поддержка Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Поддержка from running properly as controlled side."),
