...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", ""),
        ("Established", ""),
        ("connecting_status", "Свързване с Поддержка мрежата..."),
        ("Enable service", ""),
        ("Start service", ""),
        ("Service is running", ""),
        ...
        ("install_tip", "Поради UAC, Поддержка в някои случай не може да работи правилно като отдалечена достъп. За да заобиколите UAC, моля, щракнете върху бутона по-долу, за да инсталирате Поддержка в системата."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "За да управлявате вашия работен плот дистанционно, трябва да предоставите на Поддержка разрешения \"Достъпност\"."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Поддержка \"Screen Recording\" permissions."),
        ("Installing ...", ""),
        ("Install", ""),
        ("Installation", ""),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или докосване, трябва да разрешите на Поддержка да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [Поддержка Input]."),
        ...
        ("Turned off", ""),
        ("Language", ""),
        ("Keep Поддержка background service", ""),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението Поддержка, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("config_input", "За да контролирате отдалечен работен плот с клавиатура, трябва да предоставите на Поддержка разрешения \"Input Monitoring\"."),
        ("config_microphone", "За да говорите дистанционно, трябва да предоставите на Поддержка разрешения \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиранят Поддержка."),
        ...
        ("install_cert_tip", "Инсталирайте сертификат на Поддержка"),
        ("confirm_install_cert_tip", "Това е сертификат за тестване на Поддержка, на който може да се вярва. Сертификатът ще се използва за доверие и инсталиране на драйвери на Поддержка, когато е необходимо."),
        ...
        ("verify_rustdesk_password_tip", "Проверете Поддержка паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате Поддержка и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете Поддержка Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на Поддержка да работи правилно като контролирана страна."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
